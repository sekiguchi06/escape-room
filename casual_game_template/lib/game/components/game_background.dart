...
class ResponsiveGameBackground extends StatelessWidget {
  ...
  Widget _buildMainImageLayer(BoxConstraints constraints) {
    final screenWidth = constraints.maxWidth;
    final availableHeight = constraints.maxHeight - config.topReservedHeight - bottomReservedHeight;
  ...
  /// 画像レイアウト計算
  ImageLayout _calculateImageLayout(double screenWidth, double availableHeight) {
    // 常に横幅100%を使用
