...
/// 
/// 設計原則:
/// 1. games_servicesパッケージを直接使用
/// 2. Game Center/Google Play Games公式APIに準拠
/// 3. プラットフォーム固有処理を統一インターフェースで提供
...
class GamePlayer {
  ...
  @override
  String toString() => 'GamePlayer(id: $playerId, name: $displayName, signedIn: $isSignedIn)';
}
