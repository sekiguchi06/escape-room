...
import 'package:casual_game_template/framework/ui/inventory_ui_component.dart';
import 'package:casual_game_template/framework/ui/inventory_item_component.dart';
import 'package:casual_game_template/framework/ui/inventory_state_notifier.dart';
import 'package:casual_game_template/framework/ui/responsive_layout_calculator.dart';
  ...
  group('InventorySystem Tests', () {
    ...
    group('ResponsiveLayoutCalculator Tests', () {
      ...
      test('should calculate arrow positions', () {
        ...
        expect(rightArrow.x, equals(332)); // screenSize.x - buttonWidth - margin
    ...
    group('JapaneseMessageSystem Tests', () {
      test('should get correct messages', () {
        expect(JapaneseMessageSystem.getMessage('inventory_title'), equals('インベントリ'));
        expect(JapaneseMessageSystem.getMessage('inventory_empty'), equals('アイテムがありません'));
      ...
      test('should create message component correctly', () {
        ...
        expect((component as TextComponent).text, equals('インベントリ'));
      });
    });
    ...
    group('Performance Tests', () {
      testWithFlameGame('should handle maximum items without performance issues', (game) async {
