  ...
  group('🎮 Flutter公式準拠ゲームサービス テスト', () {
    ...
    group('FlutterGameServicesManager基本機能テスト', () {
      ...
      test('設定適用確認', () {
        ...
        expect(debugInfo['leaderboard_ids'], equals({'highScore': 'test_leaderboard'}));
        expect(debugInfo['achievement_ids'], equals({'firstWin': 'test_achievement'}));
      ...
      test('設定更新確認', () {
        ...
        expect(debugInfo['debug_mode'], isTrue);
        expect(debugInfo['leaderboard_ids'], equals({'score': 'new_leaderboard'}));
      });
    });
    ...
    group('GameServicesConfiguration設定テスト', () {
      ...
      test('カスタム設定確認', () {
        const config = GameServicesConfiguration(
          debugMode: true,
          autoSignInEnabled: false,
          leaderboardIds: {'main': 'main_leaderboard', 'weekly': 'weekly_leaderboard'},
        ...
        expect(config.achievementIds['beginner'], equals('beginner_achievement'));
    ...
    group('エラーハンドリングテスト', () {
      ...
      test('エラー結果処理確認', () {
        ...
        expect(networkErrorResult.result, equals(GameServiceResult.networkError));
        ...
        expect(notSupportedResult.result, equals(GameServiceResult.notSupported));
      });
    });
