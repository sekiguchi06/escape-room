  ...
  group('🎮 Flame公式events準拠InputSystem テスト', () {
    ...
    group('FlameInputProcessor テスト', () {
      ...
      test('Flame公式DragCallbacks準拠 - ドラッグ処理', () {
        ...
        expect(processor.processPanUpdate(updatePosition, Vector2(50, 50)), isTrue);
    ...
    group('FlameInputManager テスト', () {
      ...
      test('Flame公式events準拠の入力処理', () {
        ...
        expect(() => manager.handlePanUpdate(position, Vector2(10, 20)), returnsNormally);
        expect(() => manager.handlePanEnd(position, Vector2(5, 10)), returnsNormally);
