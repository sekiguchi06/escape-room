...
import 'package:escape_room/game/components/tap_particle_system.dart';
  ...
  group('タップパーティクルシステムテスト', () {
    ...
    test('3. 複数パーティクル同時発生テスト', () {
      ...
      particleSystem.emitParticle(
        ...
        TapParticleType.success,
      );
      particleSystem.emitParticle(
        const Offset(200, 200),
        TapParticleType.failure,
      );
