...
void main() {
  group('Environment Configuration Tests', () {
    ...
    test('should have valid Google Mobile Ads configuration format', () {
      ...
      expect(
        envContent,
        contains('INTERSTITIAL_AD_UNIT_ID_ANDROID=ca-app-pub'),
      );
  ...
  group('Environment File Content Tests', () {
    test('development environment should have correct values', () {
      ...
      expect(
        envContent,
        contains('API_ENDPOINT=https://dev-api.escaperoom-game.com'),
      );
    ...
    test('production environment should have different values', () {
      ...
      expect(
        envProdContent,
        contains('API_ENDPOINT=https://api.escaperoom-game.com'),
      );
      ...
      expect(
        envProdContent,
        contains('FIREBASE_PROJECT_ID=escape-master-prod'),
      );
    });
  });
}
