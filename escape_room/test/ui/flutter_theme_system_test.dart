...
void main() {
  ...
  group('🎨 Flutter公式ThemeData準拠テーマシステム テスト', () {
    group('FlutterUITheme テスト', () {
      ...
      test('カスタムパラメータ付きテーマ作成確認', () {
        final customTheme = FlutterUITheme.light(
          customColors: {'custom_color': Colors.pink},
          customFontSizes: {'custom_size': 20.0},
          customSpacings: {'custom_spacing': 12.0},
        );
    ...
    group('FlutterThemeManager テスト', () {
      ...
      test('カスタムテーマ登録・使用確認', () {
        final customTheme = FlutterUITheme.light(
          customColors: {'primary': Colors.purple, 'secondary': Colors.amber},
        );
        ...
        expect(
          manager.currentTheme.getColor('secondary'),
          equals(Colors.amber),
        );
      });
