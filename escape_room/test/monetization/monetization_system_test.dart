...
void main() {
  group('収益化システム分割テスト', () {
    test('Monetization system can be imported and used', () {
      ...
      debugPrint('✅ Monetization system refactoring test: SUCCESS');
    });
    ...
    test('Ad models work correctly', () {
      ...
      debugPrint('✅ Ad models test: SUCCESS');
    });
    ...
    test('Configuration can be updated', () {
      ...
      expect(
        updatedConfig.bannerPosition,
        equals(originalConfig.bannerPosition),
      );

      debugPrint('✅ Configuration copyWith test: SUCCESS');
    });
  });
}
