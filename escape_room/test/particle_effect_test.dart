...
void main() {
  group('ParticleEffectManager Tests', () {
    ...
    test('エフェクト設定登録', () {
      ...
      expect(() => manager.playEffect('test_effect', Vector2.zero()), 
             returnsNormally);
    });
    ...
    test('デフォルトエフェクト存在確認', () async {
      ...
      expect(() => manager.playEffect('explosion', Vector2.zero()), 
             returnsNormally);
      expect(() => manager.playEffect('sparkle', Vector2.zero()), 
             returnsNormally);
      expect(() => manager.playEffect('trail', Vector2.zero()), 
             returnsNormally);
    });
