...
class TestGameActiveState extends GameState {
  ...
  const TestGameActiveState({required this.level, required this.progress})
    : super();
  ...
  String get description =>
      'アクティブ状態 (レベル$level, 進捗${(progress * 100).toStringAsFixed(1)}%)';

  @override
  Map<String, dynamic> toJson() {
    return {...super.toJson(), 'level': level, 'progress': progress};
  }
...
class TestGameCompletedState extends GameState {
  ...
  @override
  String get description =>
      '完了状態 (最終レベル$finalLevel, 時間${completionTime.inSeconds}秒)';
