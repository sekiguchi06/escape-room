  ...
  group('🚪 EscapeRoomState移植テスト - Phase 1', () {
    ...
    group('EscapeRoomStateProvider状態遷移テスト', () {
      ...
      test('状態遷移可能性確認', () {
        // exploring状態からの遷移可能性
        expect(
          stateProvider.canTransitionTo(EscapeRoomState.inventory),
          isTrue,
        );
        ...
        stateProvider.showInventory();
        expect(
          stateProvider.canTransitionTo(EscapeRoomState.exploring),
          isTrue,
        );
        expect(stateProvider.canTransitionTo(EscapeRoomState.timeUp), isTrue);
      });
    ...
    group('移植ガイド完了判定テスト', () {
      test('EscapeRoomState状態遷移移植完了確認', () {
        ...
        debugPrint(
          '✅ EscapeRoomState状態遷移移植完了: exploring ↔ inventory ↔ puzzle の切り替え',
        );
      });
    });
  });
