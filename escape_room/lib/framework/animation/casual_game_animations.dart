...
class CasualGameAnimations {
  ...
  static void screenSlideIn(
    PositionComponent screen,
    Vector2 screenSize, {
  ...
  static void screenFadeIn(PositionComponent screen, {double duration = 0.3}) {
    screen.add(OpacityEffect.fadeIn(EffectController(duration: duration)));
  }
  ...
  static void floatingText(
    ...
    text.add(
      SequenceEffect([
        MoveEffect.by(offset, EffectController(duration: duration)),
  ...
  static void pulse(
    ...
    component.add(
      ScaleEffect.by(
        Vector2.all(scale),
        EffectController(duration: duration, alternate: true, infinite: true),
      ),
    );
  }
  ...
  static void rotate(
    ...
    component.add(
      RotateEffect.by(
        angle,
        EffectController(duration: duration, infinite: infinite),
      ),
    );
  }
