...
class AnalyticsProviderFactory {
  ...
  static AnalyticsProvider create({
    ...
    if (isTest) {
      debugPrint(
        '📊 AnalyticsProvider: ConsoleAnalyticsProvider (Test Environment)',
      );
      return ConsoleAnalyticsProvider();
    } else {
      debugPrint(
        '📊 AnalyticsProvider: FirebaseAnalyticsProvider (Production Environment)',
      );
  ...
  /// 利用可能な実装一覧
  static List<String> get availableImplementations => ['console', 'firebase'];
