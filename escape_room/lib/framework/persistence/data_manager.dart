...
class DataManager {
  ...
  Future<void> updateConfiguration(
    PersistenceConfiguration newConfiguration,
  ) async {
  ...
  /// ハイスコア保存
  Future<PersistenceResult> saveHighScore(
    int score, {
  ...
  /// ユーザー設定保存
  Future<PersistenceResult> saveUserSettings(
  ...
  Future<Map<String, dynamic>> loadUserSettings() async {
    return await loadData<Map<String, dynamic>>(
          'userSettings',
          defaultValue: {},
        ) ??
        {};
  ...
  /// ゲーム進行状況保存
  Future<PersistenceResult> saveGameProgress(
  ...
  void checkAutoSave() {
    ...
    if (elapsed >= _configuration.autoSaveInterval &&
