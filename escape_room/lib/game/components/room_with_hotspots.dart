      ...
      children: [
        ...
        Positioned.fill(
          child: Material(
            ...
            child: InkWell(
              splashColor: Colors.white.withValues(alpha: 0.4), // 白い丸い光
              highlightColor: Colors.white.withValues(alpha: 0.2), // 白い丸い光
              onTap: () {},
              child: Container(),
            ),
          ),
        ...
        Positioned(
          ...
          right: 0,
          bottom: 0,
          child: HotspotDisplay(gameSize: widget.gameSize),
        ),
      ],
    );
  }
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        // 背景（フェード効果付き）
        OptimizedSmoothGameBackground(
          config: config.copyWith(topReservedHeight: topReservedHeight),
        ...
        Positioned(
          ...
          right: 0,
          bottom: 0,
          child: HotspotDisplay(gameSize: gameSize, game: game),
        ),
      ],
    );
  }
